...
if (file_exists(XOOPS_ROOT_PATH . '/modules/portfolio/language/' . $xoopsConfig['language'] . '/admin.php')) {
    require_once XOOPS_ROOT_PATH . '/modules/portfolio/language/' . $xoopsConfig['language'] . '/admin.php';
} else {
    require_once XOOPS_ROOT_PATH . '/modules/portfolio/language/spanish/admin.php';
}
