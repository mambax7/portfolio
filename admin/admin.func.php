...
function portfolio_make_adminnav()
{
    echo "<table width='100%' class='outer' cellspacing='1'>
            <tr align='center' style='background: url(../assets/images/bgmenu.jpg) repeat-x; height: 20px;'>
            <td style='"
         . ((_PORTFOLIO_LOCATION === 'INDEX') ? 'background: url(../assets/images/bgmenuselec.jpg) repeat-x; ' : '')
         . "vertical-align: middle; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;' onmouseover=\"this.style.background='url(../assets/images/bgmenu1.jpg) repeat-x;';\" onmouseout=\"this.style.background='url(../assets/images/"
         . ((_PORTFOLIO_LOCATION === 'INDEX') ? 'bgmenuselec.jpg' : 'bgmenu.jpg')
         . ") repeat-x;';\">
            <a href='./'>"
         . _MA_PORTFOLIO_WORKS
         . "</a></td>
            <td style='"
         . ((_PORTFOLIO_LOCATION === 'NEWWORK') ? 'background: url(../assets/images/bgmenuselec.jpg) repeat-x; ' : '')
         . "vertical-align: middle; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;' onmouseover=\"this.style.background='url(../assets/images/bgmenu1.jpg) repeat-x;';\" onmouseout=\"this.style.background='url(../assets/images/"
         . ((_PORTFOLIO_LOCATION === 'NEWWORK') ? 'bgmenuselec.jpg' : 'bgmenu.jpg')
         . ") repeat-x;';\">
            <a href='./?op=new'>"
         . _MA_PORTFOLIO_NEWWORK
         . "</a></td>
            <td style='"
         . ((_PORTFOLIO_LOCATION === 'CATEGOS') ? 'background: url(../assets/images/bgmenuselec.jpg) repeat-x; ' : '')
         . "vertical-align: middle; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;' onmouseover=\"this.style.background='url(../assets/images/bgmenu1.jpg) repeat-x;';\" onmouseout=\"this.style.background='url(../assets/images/"
         . ((_PORTFOLIO_LOCATION === 'CATEGOS') ? 'bgmenuselec.jpg' : 'bgmenu.jpg')
         . ") repeat-x;';\">
            <a href='categos.php'>"
         . _MA_PORTFOLIO_CATEGOS
         . "</a></td>
            <td style='"
         . ((_PORTFOLIO_LOCATION === 'NEWCATEGO') ? 'background: url(../assets/images/bgmenuselec.jpg) repeat-x; ' : '')
         . "vertical-align: middle; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;' onmouseover=\"this.style.background='url(../assets/images/bgmenu1.jpg) repeat-x;';\" onmouseout=\"this.style.background='url(../assets/images/"
         . ((_PORTFOLIO_LOCATION === 'NEWCATEGO') ? 'bgmenuselec.jpg' : 'bgmenu.jpg')
         . ") repeat-x;';\">
            <a href='categos.php?op=new'>"
         . _MA_PORTFOLIO_NEWCATEGO
         . '</a></td>
            </tr></table><br>';
}
 ...
 * @param $filein
 * @param $fileout
 * @param $imagethumbsize_w
 * @param $imagethumbsize_h
 * @param $red
 * @param $green
 * @param $blue
 */
...
function portfolio_localize($id, $by)
{
    ...
    if ($by == 0) {
        ...
        if ($row['parent'] > 0) {
            $ret .= portfolio_localize($row['parent'], 0);
        }
