...
<table width="100%" border="0" cellspacing="0">
    <tr>
        <td width="60%" valign="top">
            <div style="border-bottom: 5px solid #CCCCCC; padding: 6px; font-size: 16px; font-weight: bold;"><{$lang_categos}></div>
            <br>
            <{foreach item=cat from=$categos}>
                <div style="padding: 2px;">
                    <img src="assets/images/section.png" border="0" align="absmiddle"> <a
                            href="categos.php?id=<{$cat.id}>"
                            style="font-size: 12px; font-weight: bold;"><{$cat.nombre}></a></div>
                <br>
                <div style="padding: 6px; padding-left: 25px; text-align: justify;"><{$cat.desc}></div>
                <br>
            <{/foreach}></td>
        <td width="40%" valign="top" class="even" style="border-left: 1px solid #CCCCCC;">
            ...
            <div style="padding: 4px; font-size: 12px; font-weight: bold; border-bottom: 1px solid #CCCCCC;">
                <img src="assets/images/recent.png" border="0" align="absmiddle"> <{$lang_recent}>
            </div>
            <div style="font-size: 11px; padding: 3px;">
                <ul>
